...
plugins=(git zsh-syntax-highlighting web-search colored-man-pages command-not-found extract npm starship zsh-autosuggestions zsh-activate-py-environment)
